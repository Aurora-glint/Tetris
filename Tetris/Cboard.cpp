    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(this->widgets, SIGNAL(time_hard()), this->widgetp, SLOT(do_time_hard())); // 关联tickchange信号和pairdotickchange槽函数
    connect(this->widgets, SIGNAL(time_crazy()), this->widgetp, SLOT(do_time_crazy())); // 关联tickchange信号和pairdotickchange槽函数
