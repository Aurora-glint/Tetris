    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(this->widgets, SIGNAL(timechange(int)), this->widgetp, SLOT(do_timechange())); // 关联timechange信号和pairdotimechange槽函数
    connect(this->widgets, SIGNAL(tickchange(int)), this->widgetp, SLOT(do_tickchange())); // 关联tickchange信号和pairdotickchange槽函数
